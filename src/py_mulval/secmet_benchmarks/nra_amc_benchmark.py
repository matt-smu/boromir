...
from py_mulval.metrics.ag_metrics import nra_amc
import py_mulval.metrics
FLAGS = flags.FLAGS

BENCHMARK_NAME = 'nra_amc'
BENCHMARK_CONFIG = """
nra_amc:
  description: Run nra metric
  flags:
...
def Run(benchmark_spec):
  """Collect NRA Metrics for an attack graph
