...
from py_mulval.metrics.ag_metrics import epl
# from py_mulval.metrics.ag_metrics import epl_unnormalized
...
def Run(benchmark_spec):
  ...
  metric = epl.epl_metric()
  # metric = epl_unnormalized.epl_metric()
