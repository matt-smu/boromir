...
hacl(pe3_m, p3_c,  tcp, 22).
hacl(pe4_m, p3_c,  tcp, 22).
...
*/
vulExists(p3_c, 'CVE-2016-xxxx',sdn).
vulProperty('CVE-2016-xxxx', remoteExploit, privEscalation).
networkServiceInfo(p3_c , sdn, _, _, root).


/* 
Shellshock CVE-2014-7169 and CVE-2014-6271 (CVSS = 10)
http://nvd.nist.gov 
