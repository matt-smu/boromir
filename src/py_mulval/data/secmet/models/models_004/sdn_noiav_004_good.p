...
/*
SDN Without IAV Network State Model
*/
...
hacl(pe1_m, pe2_m,  tcp, 22).
hacl(pe1_m, pe4_m,  tcp, 22).
hacl(pe1_m, p1_m,  tcp, 22).
hacl(pe2_m, pe3_m,  tcp, 22).
hacl(pe2_m, p1_m,  tcp, 22).
hacl(pe3_m, pe4_m,  tcp, 22).
hacl(pe3_m, p3_m,  tcp, 22).
hacl(pe4_m, p3_m,  tcp, 22).
hacl(p1_m, p2_m,  tcp, 22).
hacl(p1_m, p4_m,  tcp, 22).
hacl(p2_m, p3_m,  tcp, 22).
hacl(p3_m, p3_c,  tcp, 22).
hacl(p4_m, p3_m,  tcp, 22).

hacl(pe1_c, pe1_m,  tcp, 22).
...
/* 
Shellshock CVE-2014-7169 and CVE-2014-6271
http://nvd.nist.gov 
...
*/
/*
vulExists(p1_c, 'CVE-2014-6271',_).
vulExists(p2_c, 'CVE-2014-6271',_).
vulExists(p3_c, 'CVE-2014-6271',_).
vulExists(p4_c, 'CVE-2014-6271',_).
*/

vulExists(p1_m, 'CVE-2014-6271',_).
vulExists(p2_m, 'CVE-2014-6271',_).
vulExists(p3_m, 'CVE-2014-6271',_).
vulExists(p3_c, 'CVE-2014-6271',sshd).
vulExists(p4_m, 'CVE-2014-6271',_).

vulExists(pe1_m, 'CVE-2014-6271',_).
vulExists(pe2_m, 'CVE-2014-6271',_).
vulExists(pe3_m, 'CVE-2014-6271',_).
vulExists(pe4_m, 'CVE-2014-6271',_).
vulProperty('CVE-2014-6271', remoteExploit, privEscalation).
/*networkServiceInfo(p1_c , _, _, _, root).
networkServiceInfo(p2_c , _, _, _, root).
networkServiceInfo(p3_c , _, _, _, root).
networkServiceInfo(p4_c , _, _, _, root).
*/
networkServiceInfo(pe1_m , _, _, _, root).
networkServiceInfo(pe2_m , _, _, _, root).
networkServiceInfo(pe3_m , _, _, _, root).
networkServiceInfo(pe4_m , _, _, _, root).

networkServiceInfo(p1_m , _, _, _, root).
networkServiceInfo(p2_m , _, _, _, root).
networkServiceInfo(p3_m , _, _, _, root).
networkServiceInfo(p3_c , sshd, _, 22, root).
networkServiceInfo(p4_m , _, _, _, root).
