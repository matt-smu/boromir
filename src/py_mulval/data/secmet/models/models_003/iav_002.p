...
*/
hacl(pe1_d, p1_d,  TCP, 646).
hacl(pe2_d, p1_d, TCP, 646).
hacl(pe3_d, p3_d,  TCP, 646).
hacl(pe4_d, p3_d,  TCP, 646).
...
We'll assume static for now. 
*/
/* allow control messages through any LDP */
...
/* 
P's no longer speak BGP to other Ps
