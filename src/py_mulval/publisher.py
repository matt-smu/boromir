...
DEFAULT_JSON_OUTPUT_NAME = 'py_mulval_results.json'
...
class DefaultMetadataProvider(MetadataProvider):
  ...
  def AddMetadata(self, metadata, benchmark_spec):
    ...
    # metadata['py_mulval_version'] = version.VERSION
...
class SampleCollector(object):
  ...
  def _DefaultPublishers(cls):
    ...
    # default_json_path = '/'.join((FLAGS.output_dir, DEFAULT_JSON_OUTPUT_NAME))
