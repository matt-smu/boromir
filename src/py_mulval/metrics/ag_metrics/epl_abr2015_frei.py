...
METRIC_NAME = "epl_abr2015"
USAGE = """Accepts an attack graph and the node to start from, or looks for  the origin if no node provided"""
CITATION_SHORT = 'Abraham2015'
CITATION_FULL = """[1]Subil Abraham and Suku Nair. 2015. A predictive framework for cyber security analytics using attack graphs."""
METRIC_UNIT = "days"
METRIC_SUMMARY = """"Expected Path Length: Expected time to be absorbed from the current state (Freis weighting)."""
