...
from py_mulval.secmet_benchmarks import  metf_ml_benchmark
...
ALWAYS_SUPPORTED = 'metf_ml'
NEVER_SUPPORTED = 'metf_tm'


class _BenchmarkSpecTestCase(common_test_case.CommonTestCase):
...
class BenchmarkSupportTestCase(_BenchmarkSpecTestCase):
  ...
  def testBenchmarkSupportFlag(self):
    ...
    config = configs.LoadConfig(metf_ml_benchmark.BENCHMARK_CONFIG, {},
                                ALWAYS_SUPPORTED)
...
class RedirectGlobalFlagsTestCase(common_test_case.CommonTestCase):
